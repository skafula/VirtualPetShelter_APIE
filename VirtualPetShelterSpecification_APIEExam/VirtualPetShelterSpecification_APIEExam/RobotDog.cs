...
namespace VirtualPetShelterSpecification_APIEExam
{
    public class RobotDog : RobotPet
    {
        ...
        public RobotDog(string petName, int healthLevel, int happinessLevel, int maintenanceNeedLevel) : base(petName, healthLevel, happinessLevel, maintenanceNeedLevel)
        {
            PetName = petName;
